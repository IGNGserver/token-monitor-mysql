...
一款桌面小工具，即時顯示你各種 AI 編程工具——Claude Code、Codex、Hermes Agent、OpenCode、OpenClaw、Cursor、Antigravity 等——的 Token 用量與 AI 工具用量上限，並支援依工具、裝置、模型分項顯示。
...
- **即時 Token 追蹤**：涵蓋 Claude Code、Codex、Hermes Agent、OpenCode、OpenClaw、Cursor、Antigravity（每輪對話後 UI 在數秒內更新）

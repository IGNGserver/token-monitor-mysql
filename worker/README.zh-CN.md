...
> 属于 **[Token Monitor Suite](https://github.com/IGNGserver/token-monitor-suite)** 项目。这个目录只是 Cloudflare Worker hub；桌面小部件、无头 agent 和完整文档都在主仓库。一键部署会创建一份独立副本，不会自动更新，所以请回主仓库查看新版本。

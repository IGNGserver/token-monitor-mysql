...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    claude: '#cc7c5e', 'claude-desktop': '#d4927a', codex: '#49a3b0', hermes: '#d4af37', gemini: '#4285f4',
    ...
    openclaw: '#ff4d4d', 'deepseek-harness': '#4d6bfe', xai: '#000000', meta: '#1d65c1', mistral: '#fa520f', qwen: '#615ced',
    pi: '#000', zed: '#4173e7', kilocode: '#F8F676', commandcode: '#2d6cdf', micode: '#000000', zcode: '#000000', kiro: '#9046FF', codebuddy: '#6C4DFF', workbuddy: '#0DC8A5', proma: '#000000',

...
(function exposeThemePresets(root, factory) {
  ...
  const VENDOR_ORDER = [
    ...
    'gemini', 'antigravity', 'commandcode', 'kimi', 'qwen', 'grok', 'copilot', 'pi', 'zed', 'kilocode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'deepseek-harness', 'deepseek', 'xai', 'meta', 'mistral',

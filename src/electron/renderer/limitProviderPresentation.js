...
(function exposeLimitProviderPresentation(root, factory) {
  ...
  function limitProviderStatusLabel(provider = {}) {
    ...
    if (status === 'unauthorized') {
      if (providerName === 'kimi' || providerName === 'thirdparty') return { label: 'Update credential', tone: 'setup' };
    ...
    if (status === 'notConfigured') {
      if (providerName === 'kimi' || providerName === 'thirdparty') return { label: 'Add credential', tone: 'setup' };

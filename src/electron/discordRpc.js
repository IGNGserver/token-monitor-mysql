...
const CLIENT_LABELS = {
  ...
  pi: 'Pi', zed: 'Zed', kilocode: 'Kilo Code', micode: 'MiMo Code', zcode: 'ZCode', kiro: 'Kiro', codebuddy: 'CodeBuddy', workbuddy: 'WorkBuddy', proma: 'Proma', 'deepseek-harness': 'DeepSeek Harness', 'claude-desktop': 'Claude Desktop'
};
